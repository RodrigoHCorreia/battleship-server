...
data class FieldModel(
    val name: String,
    val type: String,
    @get:JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
...
class SirenBuilderScope<T>(
    ...
    fun linkEntity(clazz: String, rel: LinkRelation, href: URI) {
        entities.add(LinkEntityModel(listOf(clazz), listOf(rel.value), listOf(href.toASCIIString())))
    }
